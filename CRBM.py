...
class RBM(object):
    def __init__(self, n_input, n_hidden, layer_names, alpha=1.0, transfer_function=tf.nn.sigmoid):
        ...
        self.v1prob = tf.nn.relu(tf.matmul(self.h0, tf.transpose(self.rbm_w)) + self.rbm_vb)
        self.v1 = self.v1prob
    ...
    def print_weight(self):
        print("n_w:"+str(self.n_w))
        print("n_vb:"+str(self.n_vb))
        print("n_hb:"+str(self.n_hb))
        print("o_w:"+str(self.o_w))
        print("o_vb:"+str(self.o_vb))
        print("o_hb:"+str(self.o_hb))
